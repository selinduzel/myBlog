					...
					<div class="col-md-8">
						...
						<div class="row animate-box">
							<div class="col-md-12">
								...
								<x-blog.message :status="'error'"/>

								<h2 class="colorlib-heading-2">Yorum Yaz</h2>
								...
								@guest
								<p class="lead"><a href="{{ route('login') }}">Giriş </a> OR <a href="{{ route('register') }}">Kayıt Ol</a> Yorum yaz</p>
								@endguest
							</div>
						</div>
					</div>
